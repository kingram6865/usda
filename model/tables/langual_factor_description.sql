...
comment on column factor_code is 'The LanguaL factor from the Thesaurus. Only those codes used to factor the foods contained in the LanguaL Factor file are included in this file.';
comment on column description is 'The description of the LanguaL Factor Code from the thesaurus.';
