...
CREATE TABLE IF NOT EXISTS abbreviated (
  ...
  calcium NUMERIC(11),
  iron NUMERIC(11, 2),
  magnesium NUMERIC(11),
  phosphorus NUMERIC(11),
  potassium NUMERIC(11),
  sodium NUMERIC(11),
  zinc NUMERIC(11, 2),
  copper NUMERIC(11, 3),
  manganese NUMERIC(11, 3),
  selenium NUMERIC(11, 1),
  vit_c NUMERIC(11, 1),
  thiamin NUMERIC(11, 3),
  riboflavin NUMERIC(11, 3),
  niacin NUMERIC(11, 3),
  panto_acid NUMERIC(11, 3),
  vit_b6 NUMERIC(11, 3),
  folate_total NUMERIC(11),
  folic_acid NUMERIC(11),
  food_folate NUMERIC(11),
  folate_dfe NUMERIC(11),
  choline_total NUMERIC(11),
  b12 NUMERIC(11, 2),
  a_iu NUMERIC(11),
  a_rae NUMERIC(11),
  retinol NUMERIC(11),
  alpha_carotene NUMERIC(11),
  beta_carotene NUMERIC(11),
  beta_crypt NUMERIC(11),
  lycopene NUMERIC(11),
  lutzea NUMERIC(11),
  e NUMERIC(11, 2),
  d_mcg NUMERIC(11, 1),
  ...
  k NUMERIC(11, 1),
  fa_sat NUMERIC(11, 3),
  fa_mono NUMERIC(11, 3),
  fa_poly NUMERIC(11, 3),
  cholesterol NUMERIC(11, 3),
  bmwt1 NUMERIC(10, 2),
  gmwt_desc1 VARCHAR(120),
  gmwt2 NUMERIC(10, 2),
  gmwt_desc2 VARCHAR(120),
  refuse_pct NUMERIC(3)
);
